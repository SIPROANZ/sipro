           ...
           <main>
                ...
                <table class=" resumen1 margen1 ">
                                ...
                                <tr>
                                  ...
                                  <td class="titulo">{{ $ayudassociale->id}}</td>
                            ...
                            <table class="table table-bordered table-sm resumen">
                                    ...
                                    <tbody>
                                        @foreach ($detallesayudas as $detallesayuda)
                                            <tr>
                                                <td>{{ $ayudassociale->beneficiario->documentorepresentante}}
                                                <td>{{ $ayudassociale->beneficiario->nombre }}</td>
                                                <td>{{ $ayudassociale->beneficiario->banco}}</td>
                                                <td>{{ $ayudassociale->beneficiario->numerocuentarepresentante }}</td>
            ...
            <footer class="footer">
              <table class="table table-bordered">
                <thead >
                  <tr>
                    <th class="firma" >DIRECTOR(A) DE LA UNIDAD</th>
                    <th  class="firma"  >DIRECTOR(A) DE ADMINISTRACIÓN</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
