<div class="box box-info padding-1">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            {{ Form::text('montocompromiso', $ayuda->montototal, ['class' => 'form-control' . ($errors->has('montocompromiso') ? ' is-invalid' : ''), 'placeholder' => 'Monto compromiso']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('unidadadministrativa_id', $ayuda->unidadadministrativa_id, ['class' => 'form-control' . ($errors->has('unidadadministrativa_id') ? ' is-invalid' : ''), 'placeholder' => 'Unidadadministrativa']) }}
        ...
        <div class="form-group">
            {{ Form::hidden('ayuda_id', $ayuda->id, ['class' => 'form-control' . ($errors->has('ayuda_id') ? ' is-invalid' : ''), 'placeholder' => 'Ayuda']) }}
