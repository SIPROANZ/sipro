...
<table class="table">
                    ...
                    <th>Nro</th>
										...
										<th>Monto Inicial</th>
										<th>Monto Aumento</th>
										<th>Monto Disminuye</th>
										<th>Monto Actualizado</th>
										<th>Monto Precomprometido</th>
										<th>Monto Comprometido</th>
										<th>Monto Causado</th>
										<th>Monto Pagado</th>
										<th>Monto Por Comprometer</th>
										<th>Monto Por Causar</th>
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td>{{ $ejecucione->ejercicio->nombreejercicio }}</td>
                      <td>{{ $ejecucione->unidadadministrativa->unidadejecutora }}</td>
											<td>{{ $ejecucione->meta->meta }}</td>
											<td>{{ $ejecucione->clasificadorpresupuestario }}</td>
											<td>{{ $ejecucione->financiamiento->nombre }}</td>
											<td>{{ $ejecucione->monto_inicial }}</td>
                      <td>{{ $ejecucione->monto_aumento }}</td>
											<td>{{ $ejecucione->monto_disminuye }}</td>
											<td>{{ $ejecucione->monto_actualizado }}</td>
											<td>{{ $ejecucione->monto_precomprometido }}</td>
											<td>{{ $ejecucione->monto_comprometido }}</td>
											<td>{{ $ejecucione->monto_causado }}</td>
											<td>{{ $ejecucione->monto_pagado }}</td>
											<td>{{ $ejecucione->monto_por_comprometer }}</td>
											<td>{{ $ejecucione->monto_por_causar }}</td>
											<td>{{ $ejecucione->monto_por_pagar }}</td>
											<td>{{ $ejecucione->poa->proyecto}}</td>
