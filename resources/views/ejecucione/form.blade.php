<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('ejercicio_id', $ejecucione->ejercicio_id, ['class' => 'form-control' . ($errors->has('ejercicio_id') ? ' is-invalid' : ''), 'placeholder' => 'Ejercicio Id']) }}
            {!! $errors->first('ejercicio_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Institución_id') }}
            {{ Form::text('institucion_id', $ejecucione->institucion_id, ['class' => 'form-control' . ($errors->has('institucion_id') ? ' is-invalid' : ''), 'placeholder' => 'Institucion Id']) }}
            {!! $errors->first('institucion_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Unidadadministrativa_id') }}
            {{ Form::text('unidadadministrativa_id', $ejecucione->unidadadministrativa_id, ['class' => 'form-control' . ($errors->has('unidadadministrativa_id') ? ' is-invalid' : ''), 'placeholder' => 'Unidadadministrativa Id']) }}
            {!! $errors->first('unidadadministrativa_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Meta_id') }}
            {{ Form::text('meta_id', $ejecucione->meta_id, ['class' => 'form-control' . ($errors->has('meta_id') ? ' is-invalid' : ''), 'placeholder' => 'Meta Id']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('financiamiento_id', $ejecucione->financiamiento_id, ['class' => 'form-control' . ($errors->has('financiamiento_id') ? ' is-invalid' : ''), 'placeholder' => 'Financiamiento Id']) }}
        ...
        <div class="form-group">
            {{ Form::label('Poa_id') }}
            {{ Form::text('poa_id', $ejecucione->poa_id, ['class' => 'form-control' . ($errors->has('poa_id') ? ' is-invalid' : ''), 'placeholder' => 'Poa Id']) }}
