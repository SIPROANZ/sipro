                        ...
                        <tr>
                          ...
                          <th scope="col">
                            <table class="table table-bordered border-dark ">
                              ...
                              <tbody>
                              <tr>
                                <td class="titulo">REQ-{{ $requisicione->correlativo }}</td>
                                <td class="titulo">{{ $requisicione->tipossgp->denominacion }}</td>
                              </tr>
                                </tbody>
                              </table>
                          </th>
  ...
  <main>
      <table class="resumen1">
          ...
          <tr>
            ...
            <td> {{ $requisicione->unidadadministrativa->denominacion }}</td>
          </tr>
          <tr>
