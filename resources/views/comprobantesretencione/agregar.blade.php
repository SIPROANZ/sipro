                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                {{ __('Comprobantes por procesar') }}
                            </span>

                             <div class="float-right">
                                <a href="{{ route('ordenpagos.agregarcomprobante') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Crear Comprobantes') }}
                                </a>
                                <a href="{{ route('ordenpagos.agregar') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                {{ __('Por emitir') }}
                                </a>
