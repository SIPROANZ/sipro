             ...
             <table class="resumen1">
                <tr>
                   ...
                   <tr>
                      ...
                      <td> {{ $ordenpago->created_at }}</td>
                   </tr>
                   <tr>
                      <th scope="row"> <strong>Cedula de Identidad ó RIF:</strong></th>
