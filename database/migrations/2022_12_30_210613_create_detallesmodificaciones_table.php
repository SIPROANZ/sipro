...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('detallesmodificaciones', function (Blueprint $table) {
            $table->id();
            ...
            $table->double('montoacredita', 25, 2);
            $table->double('montodebita', 25, 2);

            $table->foreign('modificacion_id')->references('id')->on('modificaciones')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('detallesmodificaciones');
    }
};
